...
* [Authentik](https://github.com/goauthentik/authentik) ⭐ 25,304 | 🐛 1,074 | 🌐 Python | 📅 2026-09-01 - Open Source Identity Provider focused on flexibility and versatility.
...
* [Zitadel](https://github.com/zitadel/zitadel) ⭐ 14,921 | 🐛 1,145 | 🌐 Go | 📅 2026-09-01 - Open Source Identity solution with OpenID Connect provider (OP) and SAMLv2 ready to use.

* [Logto](https://github.com/logto-io/logto) ⭐ 14,493 | 🐛 174 | 🌐 TypeScript | 📅 2026-09-01 - An Open-source solution designed for Customer Identity and Access Management (CIAM) and Workforce Identity Management with OpenID Connect based authentication.

* [Dex](https://github.com/dexidp/dex) ⭐ 11,080 | 🐛 536 | 🌐 Go | 📅 2026-08-31 - Provider that acts as a portal to other identity providers through "connectors." like LDAP, SAML, OIDC or established identity providers like GitHub, Google, and Active Directory.

* [Pocket ID](https://github.com/pocket-id/pocket-id) ⭐ 9,074 | 🐛 94 | 🌐 Go | 📅 2026-09-01 - A simple OpenID Connect Provider that allows users to authenticate with their passkeys.
...
* [mod\_auth\_openidc](https://github.com/OpenIDC/mod_auth_openidc) ⭐ 1,093 | 🐛 1 | 🌐 C | 📅 2026-09-01 - OpenID Connect Relying Party certified implementation for Apache Server 2.x.
...
* [coreos/go-oidc](https://github.com/coreos/go-oidc) ⭐ 2,474 | 🐛 23 | 🌐 Go | 📅 2026-07-08 - Go OpenID Connect client developed by CoreOS.
* [zitadel/oidc](https://github.com/zitadel/oidc) ⭐ 1,880 | 🐛 42 | 🌐 Go | 📅 2026-08-31 - OpenID Connect client and server library certified by the OpenID Foundation.
...
* [com.google.oauth-client/google-oauth-client](https://github.com/googleapis/google-oauth-java-client) ⭐ 661 | 🐛 35 | 🌐 Java | 📅 2026-09-01 - OAuth Relying Party Java library written by Google for OAuth 2.0 with Android support.
...
* [openid-client](https://github.com/panva/node-openid-client) ⭐ 2,401 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - OpenID Certified™ Relying Party (OpenID Connect/OAuth 2.0 Client) implementation for Node.js.
...
* [Better Auth](https://github.com/better-auth/better-auth) ⭐ 29,790 | 🐛 697 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript Framework agnostic authentication library for SPAs and server-side applications.
...
* [nuxt-auth for Nuxt 2](https://github.com/nuxt-community/auth-module) ⭐ 1,924 | 🐛 205 | 🌐 TypeScript | 📅 2026-09-01 - Zero-boilerplate authentication support for Nuxt.js 2.
...
* [angular-auth-oidc-client](https://github.com/damienbod/angular-auth-oidc-client) ⭐ 1,239 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-26 - Angular certified library with OAuth 2.0 and OpenID Connect flows, and Angular schematics.
...
* [oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) ⭐ 14,899 | 🐛 257 | 🌐 Go | 📅 2026-09-01 - Reverse proxy adding OpenID Connect and OAuth 2.0 based authentication in front of any application.
* [Vouch Proxy](https://github.com/vouch/vouch-proxy) ⭐ 3,282 | 🐛 66 | 🌐 Go | 📅 2026-07-03 - SSO solution using OpenID Connect for Nginx and Traefik reverse proxies.
...
* [traefikoidc](https://github.com/lukaszraczylo/traefikoidc) ⭐ 209 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - OpenID Connect Relying Party middleware plugin for Traefik.
...
* [SecureAuthCorp/oauth2c](https://github.com/SecureAuthCorp/oauth2c) ⭐ 943 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - OAuth 2.0 and OpenID Connect command line client for testing and exploring different flows.
