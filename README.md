# Awesome OpenID Connect with stars
...
* [Authentik](https://github.com/goauthentik/authentik) ⭐ 25,420 | 🐛 1,071 | 🌐 Python | 📅 2026-09-10 - Open Source Identity Provider focused on flexibility and versatility.

* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,530 | 🐛 97 | 🌐 Go | 📅 2026-07-29 - Open Source OpenID Certified™ OpenID Connect and OAuth Provider.

* [Zitadel](https://github.com/zitadel/zitadel) ⭐ 14,984 | 🐛 1,168 | 🌐 Go | 📅 2026-09-09 - Open Source Identity solution with OpenID Connect provider (OP) and SAMLv2 ready to use.

* [Logto](https://github.com/logto-io/logto) ⭐ 14,513 | 🐛 181 | 🌐 TypeScript | 📅 2026-09-10 - An Open-source solution designed for Customer Identity and Access Management (CIAM) and Workforce Identity Management with OpenID Connect based authentication.

* [Dex](https://github.com/dexidp/dex) ⭐ 11,084 | 🐛 537 | 🌐 Go | 📅 2026-09-10 - Provider that acts as a portal to other identity providers through "connectors." like LDAP, SAML, OIDC or established identity providers like GitHub, Google, and Active Directory.

* [Pocket ID](https://github.com/pocket-id/pocket-id) ⭐ 9,146 | 🐛 93 | 🌐 Go | 📅 2026-09-08 - A simple OpenID Connect Provider that allows users to authenticate with their passkeys.

* [OpenIddict](https://github.com/openiddict/openiddict-core) ⭐ 5,243 | 🐛 6 | 🌐 C# | 📅 2026-09-06 - .NET Open Source OpenID Connect Provider implementation with ASP.NET Core 2.1 (and higher) applications support.

* [panva/node-oidc-provider](https://github.com/panva/node-oidc-provider) ⭐ 3,807 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Open Source and certified OpenID Connect provider implementation in Node.js with FAPI 1.0 and FAPI 2.0 support.

* [Ory Polis (formerly BoxyHQ Jackson)](https://github.com/ory/polis) ⭐ 2,263 | 🐛 31 | 🌐 TypeScript | 📅 2026-07-27 - Open Source Enterprise SSO bridges or proxies a SAML login flow to OpenID Connect with also user directory sync capabilities.

* [MITREid Connect](https://github.com/mitreid-connect/OpenID-Connect-Java-Spring-Server) ⭐ 1,508 | 🐛 260 | 🌐 Java | 📅 2024-06-05 - Open Source OpenID Connect reference implementation in Java.
...
* [mod\_auth\_openidc](https://github.com/OpenIDC/mod_auth_openidc) ⭐ 1,093 | 🐛 1 | 🌐 C | 📅 2026-09-10 - OpenID Connect Relying Party certified implementation for Apache Server 2.x.
* [liboauth2](https://github.com/OpenIDC/liboauth2) ⭐ 139 | 🐛 2 | 🌐 C | 📅 2026-09-10 - Generic library to build C-based OpenID Connect Provider and Relying Party.
...
* [oidcc](https://github.com/erlef/oidcc) ⭐ 239 | 🐛 13 | 🌐 Erlang | 📅 2026-09-06 - Certified OpenID Connect Relying Party client library for Erlang and Elixir with FAPI support.

### Golang

* [coreos/go-oidc](https://github.com/coreos/go-oidc) ⭐ 2,477 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Go OpenID Connect client developed by CoreOS.
* [zitadel/oidc](https://github.com/zitadel/oidc) ⭐ 1,887 | 🐛 42 | 🌐 Go | 📅 2026-09-09 - OpenID Connect client and server library certified by the OpenID Foundation.
...
* [openid-client](https://github.com/panva/node-openid-client) ⭐ 2,406 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - OpenID Certified™ Relying Party (OpenID Connect/OAuth 2.0 Client) implementation for Node.js.
* [oidc-client-ts](https://github.com/authts/oidc-client-ts) ⭐ 1,947 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript OpenID Client and OAuth 2.0 client for browser-based applications.
* [oauth4webapi](https://github.com/panva/oauth4webapi) ⭐ 777 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-05 - OAuth 2/OpenID Connect library for JavaScript Runtimes.

*Libraries layer focused on specific framework integration*

* [Better Auth](https://github.com/better-auth/better-auth) ⭐ 29,896 | 🐛 717 | 🌐 TypeScript | 📅 2026-09-10 - TypeScript Framework agnostic authentication library for SPAs and server-side applications.
* [angular-oauth2-oidc](https://github.com/manfredsteyer/angular-oauth2-oidc) ⭐ 1,982 | 🐛 307 | 🌐 TypeScript | 📅 2026-07-05 - Library which bring support for OAuth 2.0 and OpenID Connect (OIDC) in Angular.
* [nuxt-auth for Nuxt 2](https://github.com/nuxt-community/auth-module) ⭐ 1,924 | 🐛 205 | 🌐 TypeScript | 📅 2026-09-09 - Zero-boilerplate authentication support for Nuxt.js 2.
* [nuxt-auth for Nuxt3](https://github.com/sidebase/nuxt-auth) ⭐ 1,551 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-04 - Nuxt 3 user authentication and sessions library. nuxt-auth wraps NextAuth.js.
* [angular-auth-oidc-client](https://github.com/damienbod/angular-auth-oidc-client) ⭐ 1,238 | 🐛 275 | 🌐 TypeScript | 📅 2026-09-10 - Angular certified library with OAuth 2.0 and OpenID Connect flows, and Angular schematics.
...
* [Laravel Socialite](https://github.com/laravel/socialite) ⭐ 5,746 | 🐛 3 | 🌐 PHP | 📅 2026-09-04 - Laravel wrapper around OAuth 1 & OAuth 2 libraries with OpenID Connect support.
* [thephpleague/oauth2-client](https://github.com/thephpleague/oauth2-client) ⭐ 3,821 | 🐛 64 | 🌐 PHP | 📅 2026-08-10 - Integration with OAuth 2.0 service providers for PHP.
...
* [Authlib](https://github.com/authlib/authlib) ⭐ 5,417 | 🐛 144 | 🌐 Python | 📅 2026-08-31 - Python library in building OAuth and OpenID Connect servers and clients.
* [mozilla-django-oidc](https://github.com/mozilla/mozilla-django-oidc/) ⭐ 557 | 🐛 89 | 🌐 Python | 📅 2026-01-07 - A Django OpenID Connect relying party library maintained by Mozilla.

### Ruby

* [openid\_connect](https://github.com/nov/openid_connect) ⭐ 429 | 🐛 7 | 🌐 Ruby | 📅 2026-06-17 - Ruby OpenID Connect Relying party (RP) and Provider (OP) library.
* [omniauth\_openid\_connect](https://github.com/omniauth/omniauth_openid_connect) ⭐ 199 | 🐛 54 | 🌐 Ruby | 📅 2026-03-16 - OpenID Connect Strategy for Ruby OmniAuth library.

### Rust

* [openidconnect](https://github.com/ramosbugs/openidconnect-rs) ⭐ 638 | 🐛 76 | 🌐 Rust | 📅 2025-11-08 - OpenID Connect Relying party (RP) library for Rust.

## Relying Parties (RP) Software Plugins

* [oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) ⭐ 14,941 | 🐛 280 | 🌐 Go | 📅 2026-09-09 - Reverse proxy adding OpenID Connect and OAuth 2.0 based authentication in front of any application.
* [Vouch Proxy](https://github.com/vouch/vouch-proxy) ⭐ 3,284 | 🐛 65 | 🌐 Go | 📅 2026-07-03 - SSO solution using OpenID Connect for Nginx and Traefik reverse proxies.
* [caddy-security](https://github.com/greenpau/caddy-security) ⭐ 2,234 | 🐛 21 | 🌐 Go | 📅 2026-06-29 - OpenID Connect Relying Party authentication plugin for the Caddy web server.
* [lua-resty-openidc](https://github.com/zmartzone/lua-resty-openidc) ⭐ 1,072 | 🐛 71 | 🌐 Lua | 📅 2026-09-05 - OpenID Connect Relying Party and OAuth 2.0 client Lua library for NGINX/OpenResty.
* [traefikoidc](https://github.com/lukaszraczylo/traefikoidc) ⭐ 211 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - OpenID Connect Relying Party middleware plugin for Traefik.
...
* [SecureAuthCorp/oauth2c](https://github.com/SecureAuthCorp/oauth2c) ⭐ 945 | 🐛 6 | 🌐 Go | 📅 2026-09-10 - OAuth 2.0 and OpenID Connect command line client for testing and exploring different flows.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/cerberauth/awesome-openidconnect/blob/master/CONTRIBUTING.md) ⭐ 123 | 🐛 2 | 🌐 HTML | 📅 2026-09-03 first.
