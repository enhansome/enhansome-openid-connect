...
* [Authentik](https://github.com/goauthentik/authentik) ⭐ 25,414 | 🐛 1,128 | 🌐 Python | 📅 2026-09-09 - Open Source Identity Provider focused on flexibility and versatility.

* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,527 | 🐛 97 | 🌐 Go | 📅 2026-07-29 - Open Source OpenID Certified™ OpenID Connect and OAuth Provider.

* [Zitadel](https://github.com/zitadel/zitadel) ⭐ 14,971 | 🐛 1,164 | 🌐 Go | 📅 2026-09-09 - Open Source Identity solution with OpenID Connect provider (OP) and SAMLv2 ready to use.

* [Logto](https://github.com/logto-io/logto) ⭐ 14,512 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-09 - An Open-source solution designed for Customer Identity and Access Management (CIAM) and Workforce Identity Management with OpenID Connect based authentication.

* [Dex](https://github.com/dexidp/dex) ⭐ 11,082 | 🐛 534 | 🌐 Go | 📅 2026-09-09 - Provider that acts as a portal to other identity providers through "connectors." like LDAP, SAML, OIDC or established identity providers like GitHub, Google, and Active Directory.

* [Pocket ID](https://github.com/pocket-id/pocket-id) ⭐ 9,136 | 🐛 93 | 🌐 Go | 📅 2026-09-08 - A simple OpenID Connect Provider that allows users to authenticate with their passkeys.

* [OpenIddict](https://github.com/openiddict/openiddict-core) ⭐ 5,242 | 🐛 6 | 🌐 C# | 📅 2026-09-06 - .NET Open Source OpenID Connect Provider implementation with ASP.NET Core 2.1 (and higher) applications support.

* [panva/node-oidc-provider](https://github.com/panva/node-oidc-provider) ⭐ 3,807 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-05 - Open Source and certified OpenID Connect provider implementation in Node.js with FAPI 1.0 and FAPI 2.0 support.
...
* [mod\_auth\_openidc](https://github.com/OpenIDC/mod_auth_openidc) ⭐ 1,093 | 🐛 1 | 🌐 C | 📅 2026-09-04 - OpenID Connect Relying Party certified implementation for Apache Server 2.x.
* [liboauth2](https://github.com/OpenIDC/liboauth2) ⭐ 139 | 🐛 2 | 🌐 C | 📅 2026-08-12 - Generic library to build C-based OpenID Connect Provider and Relying Party.
...
* [oidcc](https://github.com/erlef/oidcc) ⭐ 239 | 🐛 12 | 🌐 Erlang | 📅 2026-09-06 - Certified OpenID Connect Relying Party client library for Erlang and Elixir with FAPI support.

### Golang

* [coreos/go-oidc](https://github.com/coreos/go-oidc) ⭐ 2,475 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Go OpenID Connect client developed by CoreOS.
...
* [oidc-client-ts](https://github.com/authts/oidc-client-ts) ⭐ 1,946 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript OpenID Client and OAuth 2.0 client for browser-based applications.
...
* [Better Auth](https://github.com/better-auth/better-auth) ⭐ 29,886 | 🐛 720 | 🌐 TypeScript | 📅 2026-09-09 - TypeScript Framework agnostic authentication library for SPAs and server-side applications.
...
* [angular-auth-oidc-client](https://github.com/damienbod/angular-auth-oidc-client) ⭐ 1,239 | 🐛 273 | 🌐 TypeScript | 📅 2026-09-09 - Angular certified library with OAuth 2.0 and OpenID Connect flows, and Angular schematics.
...
* [Authlib](https://github.com/authlib/authlib) ⭐ 5,416 | 🐛 144 | 🌐 Python | 📅 2026-08-31 - Python library in building OAuth and OpenID Connect servers and clients.
...
* [omniauth\_openid\_connect](https://github.com/omniauth/omniauth_openid_connect) ⭐ 199 | 🐛 52 | 🌐 Ruby | 📅 2026-03-16 - OpenID Connect Strategy for Ruby OmniAuth library.
...
* [oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) ⭐ 14,931 | 🐛 280 | 🌐 Go | 📅 2026-09-09 - Reverse proxy adding OpenID Connect and OAuth 2.0 based authentication in front of any application.
...
* [caddy-security](https://github.com/greenpau/caddy-security) ⭐ 2,234 | 🐛 22 | 🌐 Go | 📅 2026-06-29 - OpenID Connect Relying Party authentication plugin for the Caddy web server.
...
* [traefikoidc](https://github.com/lukaszraczylo/traefikoidc) ⭐ 210 | 🐛 5 | 🌐 Go | 📅 2026-09-02 - OpenID Connect Relying Party middleware plugin for Traefik.
...
* [SecureAuthCorp/oauth2c](https://github.com/SecureAuthCorp/oauth2c) ⭐ 945 | 🐛 5 | 🌐 Go | 📅 2026-08-19 - OAuth 2.0 and OpenID Connect command line client for testing and exploring different flows.
